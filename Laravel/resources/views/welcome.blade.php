    ...
    <div id="bannerCarousole" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-caption banner-slider-inner d-flex h-100 text-center">
                    <div class="carousel-content container">
                        <div class="text-center">
                            <h1>Real Estate Investment Joint Ventures... Simplified</h1>
                            <p>
                               Historically, these kinds of deals were reserved for the affluent
                           </p>
            ...
            <div class="carousel-caption banner-slider-inner d-flex h-100 text-center">
                <div class="carousel-content container">
                    <div class="text-right">
                        <h1>We Are Leveling The Real Estate Investment Playing Field</h1>
                        <p>
                            We don't care if you are accredited or not. Sign up for a free webinar today to learn how you can get started!
                        </p>
        ...
        <div class="carousel-item banner-max-height">
            ...
            <div class="carousel-caption banner-slider-inner d-flex h-100 text-center">
                <div class="carousel-content container">
                    <div class="text-left">
                        <h1>Monthly Rent Payments From Your Ownership</h1>
                        <p>
                            Monthly rental income is just the beginning... Benefit from appreciation and the ability to sell your ownership when it is right for you.
                        </p>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                    <div class="footer-item">
                        ...
                        <ul class="contact-info">
                            ...
                            <li>
                                <i class="flaticon-mail"></i><a href="mailto:sales@hotelempire.com">info@LiquidEquity.com</a>
                            </li>
                            <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-8">
                    <p class="copy">© 2019 <a href="#">Liquid Equity Inc.</a> All Rights Reserved.</p>
                </div>
                                    ...
                                    <div id="part3">
                                        ...
                                        <!--<div class="dropdown bootstrap-select search-fields">-->
                                            <select class="form-control search-fields" tabindex="-98">
                                                <option>Billborad</option>
                                                <option>Radio</option>
                                                <option>Web Search</option>
                                                <option>Refered By a Friend</option>
                                                <option>Other</option>
                                            </select>
                                        ...
                                        <div id="part7">
                                            ...
                                            <input placeholder="Open textbox" class="form-control" type="text">
                                            <div class="progress">
                                        ...
                                        <div id="part8">
                                            ...
                                            <!--<div class="dropdown bootstrap-select search-fields">-->
                                                <select class="form-control search-fields" tabindex="-98">
                                                    <option>Before 8 AM</option>
                                                    <option>8 AM to Noon</option>
                                                    <option>Noon to 5 PM</option>
                                            ...
                                            <div id="part9">
                                                ...
                                                <div class="btn-group btn-group-lg btn-group-justified" role="group" aria-label="...">
                                                    ...
                                                    <label for="step10" id="back-step10" class="back">
                                                        <div class="btn btn-theme btn-sm customNavBtn" role="button">Join Now</div>
                                                    </label>

                                                      
                                                    <label for="step11" id="continue-step11" class="continue">
                                                        <div class="btn btn-theme btn-sm customNavBtn" role="button">Contact me First</div>
                                                    </label>
                                            ...
                                            <div id="part10">
                                                ...
                                                <!--<div class="dropdown bootstrap-select search-fields">-->
                                                    ...
                                                    <div id="part11">
                                                        ...
                                                        <p>Thank you for your interest in Liquid Equity! We will have one of our
